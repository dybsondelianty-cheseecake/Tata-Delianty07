...
# ==========================
    ...
    sub_menu = st.radio("Aksi Anggota", ["Pendaftaran Anggota", "Daftar Anggota Aktif", "Pembayaran Denda"])
    ...
    # Pilihan Metode Pembayaran sesuai permintaan Anda
    metode = st.selectbox("Pilih Metode Pembayaran",["Tunai / Kasir Perpustakaan", "E-Wallet (OVO / GoPay / Dana)", "Transfer Bank (Virtual Account)"])
    if st.button("Proses Pembayaran"):
        ...
        else:st.warning("Pastikan ID Anggota telah diisi dan nominal bayar lebih dari Rp 0.")
